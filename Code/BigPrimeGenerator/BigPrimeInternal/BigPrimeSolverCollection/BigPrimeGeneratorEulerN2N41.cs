...
{
  private class BigPrimeGeneratorEulerN2N41
  {
    ...
    {
      var mi = Sqrt(min - 41) - 1;
      while (mi * mi - mi + 41 < min) mi++;

      var ma = Sqrt(max - 41) - 1;
      while (ma * ma - ma + 41 < max) ma++;
